    ...
    <AuthenticatedLayout>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center">
            <div class="w-full max-w-4xl bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-300 dark:border-gray-700">
                ...
                <!-- Header -->
                <Header title="Stress Assessment Results" subtitle="Review your stress assessment results below." />

                <div class="p-8 text-gray-900 dark:text-gray-100">

                    <!-- Latest Result -->
                    <div v-if="results" class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg mb-4">
                        <p class="text-lg font-medium">Your Total Stress Score:</p>
                    ...
                    <!-- No Results -->
                    <div v-if="!results" class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg mb-4">
                        <p class="text-lg font-medium text-gray-600">No stress assessment results found.</p>
                    </div>
                    ...
                    <div v-if="pastResults && pastResults.length > 0" class="mt-6">
                        ...
                        <div v-for="(result, index) in pastResults" :key="index" class="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg mb-4">
                            <p class="text-lg font-medium">Total Stress Score:</p>
                    ...
                    <div class="mt-6">
                        <a href="/assessment/stress-related"
