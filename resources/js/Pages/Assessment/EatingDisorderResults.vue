...
// Get SCOFF assessment results from Laravel backend
const page = usePage();
...
const retakeAssessment = () => {
    router.visit('/assessment/eating-disorder', { method: 'get', preserveState: false });
};
            ...
            <div class="w-full max-w-3xl sm:px-6 lg:px-8">
                <div class="bg-blue-100 shadow-md dark:bg-gray-800 sm:rounded-lg p-6">
                    <h2 class="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-4">
                        SCOFF Eating Disorder Assessment Results
                    </h2>

                    <!-- Latest SCOFF Assessment Result -->
